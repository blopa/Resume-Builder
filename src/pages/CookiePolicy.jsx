    ...
    return (
        <Layout>
            <SEO
                ...
                keywords={[intl.formatMessage({ id: 'cookie_law.title' })]}
            />
            <Typography className={classes.cookiePolicyText} color="textPrimary" variant="h4">
                {intl.formatMessage({ id: 'cookie_law.title' })}
            </Typography>
            <div className={classes.cookiePolicyWrapper}>
                <Typography className={classes.cookiePolicySectionText} color="textPrimary" variant="h6">
                ...
                <Typography color="textPrimary" variant="body2">
                    ...
                    <a
                        ...
                        href={intl.formatMessage({
                            id: 'cookie_law.what_are_cookies_more_info_url',
                        })}
                    >
                        {intl.formatMessage({
                            id: 'cookie_law.what_are_cookies_more_info_url',
                ...
                <Typography color="textPrimary" variant="body2">
                    {intl.formatMessage({
                        id: 'cookie_law.site_preferences_cookie_text',
                    })}
                </Typography>

                <Typography className={classes.cookiePolicyThirdPartySubtitle} color="textPrimary" variant="subtitle1">
                    ...
                    <ListItem>
                        <ListItemText
                            primary={intl.formatMessage({
                                id: 'cookie_law.third_party_cookies_item_1',
                            })}
                        />
                    </ListItem>
                    <ListItem>
                        <ListItemText
                            primary={intl.formatMessage({
                                id: 'cookie_law.third_party_cookies_item_2',
                            })}
                        />
                    </ListItem>
                </List>
